...
<div class="body">
    <div class="panel">
           ...
           if(!isset($_GET['revisar'])){
            ...
            <form method="get" class="form" action="notas.php">
                ...
                <label>Seleccione la Jornada</label><br>
                ...
                <br><br>
                <button type="submit" name="revisar" value="1">Ingresar Notas</button> <a class="btn-link" href="listadonotas.php">Consultar Notas</a>
                <br><br>
            </form>
        <?php
           }
 ...
 where id_grado = ".$id_grado." and id_seccion = ".$id_seccion." group by a.id");
            ...
            ?>
            <br>
            <a href="notas.php" class="back-link"><strong><i class="fas fa-arrow-left"></i> Volver</strong></a>
            ...
            <table class="table" cellpadding="0" cellspacing="0">
                ...
                <br>
                <button type="submit" name="insertar" class="save-button"><i class="fas fa-save"></i> Guardar</button>
                <button type="reset" class="clear-button">
  <i class="fas fa-lightbulb"></i> Limpiar
</button>

<a class="btn-link" href="listadonotas.php">Consultar Notas</a>
